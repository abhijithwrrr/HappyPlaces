...
import com.abhijith.happyplaces.database.DatabaseHandler
import com.abhijith.happyplaces.databinding.ActivityAddHappyPlaceBinding
import com.abhijith.happyplaces.models.HappyPlaceModel
import com.abhijith.happyplaces.utils.GetAddressFromLatLng
...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //action bar font is in white color because we set up the customToolbarTheme in themes.xml
        ...
        when (v!!.id) {
            ...
            R.id.tv_add_image -> {
                ...
                val pictureDialogItems =
                    arrayOf("Select photo from Gallery", "Capture from phone")
